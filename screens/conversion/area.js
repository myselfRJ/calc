            ...
            <View
              ...
              <View
                ...
                <DataTable style={{backgroundColor: '#EFFFFD'}}>
                  ...
                  <DataTable.Row>
                    <DataTable.Cell textStyle={{fontSize: 16}} style={{justifyContent:'flex-end'}} >
                      {(height*calcheight*0.00062*0.00062)
                        .toFixed(5)
                        .replace(/([0-9]+(\.[0-9]+[1-9])?)(\.?0+$)/, '$1')}
                    </DataTable.Cell>
                    <DataTable.Cell textStyle={{fontSize: 16}}>
