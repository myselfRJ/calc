...
const Triangle1 = ({route, navigation}) => {
  ...
  React.useEffect(() => {
    setarea(length * width * 0.5);
    setcalcarea(calclength * calcwidth);
    setperimeter(parseFloat(length*calclength) + parseFloat(width*calcwidth) + Math.sqrt(parseFloat(length*calclength*length*calclength) + parseFloat(width*calcwidth*width*calcwidth))) ;
    setcalcperimeter('1');
    console.log('changed');
        ...
        <View
          ...
          <View style={{width: '94%', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.text}>Calculation of Triangle Area</Text>
            </TouchableOpacity>
            <View
              style={{
                marginBottom: 5,
