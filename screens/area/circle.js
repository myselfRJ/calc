...
const Circle1 = ({route, navigation}) => {
  ...
  React.useEffect(() => {
    setarea(length * length * 3.14);
    setcalcarea(calclength * calclength);
    setperimeter(2 * length * 3.14);
    setcalcperimeter(calclength);
    console.log('changed');
  }, [length, calclength]);
        ...
        <View
          ...
          <View style={{width: '94%', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.text}>Calculation of Circle Area</Text>
            </TouchableOpacity>
            <View
              style={{
                marginBottom: 5,
