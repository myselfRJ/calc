...
const Rect1 = ({route, navigation}) => {
  ...
  React.useEffect(() => {
    ...
    console.log(calclength,calcwidth);
    setcalcarea(calclength * calcwidth);
    setperimeter(2 * (parseFloat(length*calclength) + parseFloat(width*calcwidth)) );
    setcalcperimeter('1');
    console.log('changed');
        ...
        <View
          ...
          <View style={{width: '94%', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.text}>Calculation of Rectangle Area</Text>
            </TouchableOpacity>
            <View
              style={{
                marginBottom: 5,
