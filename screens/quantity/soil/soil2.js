...
const Soil2 = ({route, navigation}) => {
  const viewShot = React.useRef();
  const [moistcontent, setmoistContent] = React.useState('0');
            ...
            <View
              ...
              <View
                style={{
                  ...
                  value={moistcontent}
                  right={<TextInput.Affix textStyle={{color:'#00ADB5',fontWeight:'700'}} text="W" />}
              ...
              <View
                ...
                <Button
                  ...
                  icon="calculator"
                  mode="contained"
                  onPress={() => {setCalculate((spgravity * unitwaterwt)*(1+moistcontent) / (1 + voidratio));
                  }}>
                  Calculate
                </Button>
                <Button
