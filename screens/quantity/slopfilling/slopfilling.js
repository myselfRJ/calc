...
const Slop1 = ({route, navigation}) => {
  const viewShot = React.useRef();
  const [calclength, setcalcLength] = React.useState('1');
  const [calclength1, setcalcLength1] = React.useState('1');
  ...
  const [length1, setLength1] = React.useState('3');
  ...
  React.useEffect(() => {
    setVolume(parseFloat(length *calclength)+parseFloat(length1*calclength1) );
    setcalcVolume(width * thick*quantity * calcwidth * calcthick*0.5);
    console.log('changed');
        ...
        <View
          ...
          <View style={{width: '94%', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.text}>Slop Filling</Text>
            </TouchableOpacity>
            <View
              style={{
                marginBottom: 5,
              ...
              <Text style={{color: '#00ADB5'}}>Dimensions of Embankment :</Text>
              <LengthView
