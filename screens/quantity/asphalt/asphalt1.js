...
const Asphalt1 = ({route, navigation}) => {
        ...
        <View
          ...
          <View style={{width: '94%', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.text}>Calculation of Asphalt</Text>
            </TouchableOpacity>
            <View
              style={{
                marginBottom: 5,
              ...
              <Text style={{color: '#00ADB5'}}>Dimensions of Road :</Text>
              <LengthView
                label={'Length L'}
                value={calclength}
                text={length}
            ...
            <View
              ...
              <Text style={{color: '#00ADB5'}}>Asphalt Quantity and Price :</Text>
              ...
              <View
               ...
               <TextInput
                ...
                <TextInput
                  ...
                  dense={true}
                  mode={'outlined'}
                  right={<TextInput.Affix textStyle={{color:'#00ADB5',fontWeight:'700'}} text={'per ton'} />}
                  activeOutlineColor="#00ADB5"
                  keyboardType="numeric"
                  label={'Asphalt Price'}
                  value={asphaltPrice}
                  onChangeText={text => setasphaltPrice(parseFloat(text))}
                />
              ...
              <View
                ...
                {toggle === 'm' ? (
                  <DataTable style={{backgroundColor: '#EFFFFD'}}>
                    ...
                    <DataTable.Row>
                      <DataTable.Cell textStyle={{fontSize:10}}>Asphalt</DataTable.Cell>
                      <DataTable.Cell textStyle={{fontSize:10}} numeric>
                        {(
                          volume *
                          calcvolume *2.322
